    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center px-5 sm:px-8 py-32 md:py-40 overflow-hidden text-center z-10">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center gap-6">
        ...
        >
          ...
          <span className="text-slate-900 dark:text-foreground hover:text-accent transition-colors cursor-crosshair">
            complex fintech architectures
          </span>{" "}
        ...
        >
          ...
          >
            ...
            <svg
              className="relative z-10 w-5 h-5 text-[#25D366]"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
      ...
      >
        ...
        <div className="relative rounded-2xl border border-black/10 dark:border-white/10 bg-background/80 backdrop-blur-xl p-5 text-left font-mono shadow-2xl overflow-hidden">
          ...
          <div className="flex items-center gap-2 mb-4 border-b border-black/10 dark:border-white/10 pb-4">
            ...
            <span className="ml-2 text-[12px] text-slate-500 dark:text-[#8C9EFF]/50">
              agent@atsighi:~
            </span>
          </div>
          ...
          <div className="text-[13px] md:text-[14px] leading-[1.8] text-slate-700 dark:text-foreground/70">
            <p>
              <span className="text-emerald-600 dark:text-[#00E676]">➜</span>{" "}
              <span className="text-indigo-600 dark:text-[#8C9EFF]">~</span>{" "}
              <span className="font-semibold text-foreground">cat</span>{" "}
              identity.yaml
            </p>
            <p className="mt-2 pl-4 text-slate-600 dark:text-[#8C9EFF]/80">
              name:{" "}
              <span className="text-indigo-700 dark:text-[#c7cfff]">
                "{personalInfo.name}"
              </span>
            </p>
            <p className="pl-4 text-slate-600 dark:text-[#8C9EFF]/80">
              role:{" "}
              <span className="text-indigo-700 dark:text-[#c7cfff]">
                "{personalInfo.role}"
              </span>
            ...
            <p className="pl-4 text-slate-600 dark:text-[#8C9EFF]/80">
              status:{" "}
              <span className="text-emerald-600 dark:text-[#00E676]">
            ...
            <p className="pl-12 text-indigo-700 dark:text-[#c7cfff]">
              "Next.js App Router",
            </p>
            <p className="pl-12 text-indigo-700 dark:text-[#c7cfff]">
              "Node.js Ecosystem",
            ...
            <p className="mt-2">
              <span className="text-emerald-600 dark:text-[#00E676]">➜</span>{" "}
              <span className="text-indigo-600 dark:text-[#8C9EFF]">~</span>{" "}
              <span className="inline-block w-2.5 h-4 bg-foreground/80 animate-pulse translate-y-1" />
            </p>
          </div>
        </div>
      </div>
